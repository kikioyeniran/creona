...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    ...
                    <p class="pageheader-text">Approved Featured Works</p><div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Approved Featured Works</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <h5 class="card-header">Approved Featured Works</h5>
            </div>
                        ...
                        <figure class="figure">
                            ...
                            <div class="figure-img">
                                ...
                                <div class="figure-action">
                                    <a href="/featured-works/restore/{{$post->id}}" class ='btn btn-block btn-sm btn-danger' onclick="return confirm('If you restore this post, people will now be able to see it. Are you sure you want to go ahead?');" >Restore Featured Work</a></div>
                            </div>
                            <!-- /.figure-img -->
                            <!-- .figure-caption -->
