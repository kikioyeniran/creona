        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    ...
                    <p class="pageheader-text">Edit Ebooks</p>
        ...
        <div class="row">
         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['action' => ['EbooksController@store', $post->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    {{Form::textarea('description', $post->description, ['class' => 'form-control', 'placeholder' => 'Ebooks Description..', 'rows' => 2])}}
                                </div>
