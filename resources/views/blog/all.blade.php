...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    ...
                    <p class="pageheader-text">Blog</p>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <h5 class="card-header">Click Title to Edit Blog Post</h5>
            </div>
                        ...
                        <figure class="figure">
                            ...
                            <div class="figure-img">
                                ...
                                <div class="figure-action">
                                    <a href="/blog/archive/{{$post->id}}" class ='btn btn-block btn-sm btn-danger' onclick="return confirm('Are you sure you want to archive this post?');" >Archive Blog Article</a>
                                </div>
                            </div>
                            <!-- /.figure-img -->
                            <!-- .figure-caption -->
