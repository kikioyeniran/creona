...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    ...
                    <p class="pageheader-text">Edit Tutorials</p>
        ...
        <div class="row">
         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Edit Tutorials</h5>
                <div class="card-body">
                    {!! Form::open(['action' => ['TutorialsController@store', $post->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::text('tutor', $post->tutor, ['class' => 'form-control'])}}
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    {{Form::text('preview_link', $post->preview_link, ['class' => 'form-control'])}}
                                </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="inputText3" class="col-form-label">Tutorial Video Description</label>
                                    {{Form::textarea('description', $post->description, ['class' => 'form-control', 'placeholder' => 'Tutorials Description..', 'rows' => 2])}}
                                </div>
